...
# Room class represents a room with a number and availability schedule
class Room:
    def _init_(self, number, availability_schedule):
        self._number = number
        self._availability_schedule = availability_schedule
...
class Data:
    def _init_(self, num_rooms, room_names, event_names, start_time, end_time, room_availability):
        self._rooms = []
        self._events = []
